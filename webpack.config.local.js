...
if (process.env.NODE_ENV == "production") {
	//Paket analizi yapmanız gerektiğinde bir eklenti kullanın
	plugins = [new BundleAnalyzerPlugin(), new CleanWebpackPlugin()];
	//eklentiler = [yeni CleanWebpackPlugin()];
} else if (process.env.NODE_ENV == "development") {
	// const vendorManifest = require("./dist/json/vendor-manifest.json");
	// plugins = [new webpack.DllReferencePlugin({ manifest: sellerManifest })];
}
